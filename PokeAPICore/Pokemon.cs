...
namespace PokeAPICore
{
    ...
    public class Pokemon
    {
        ...
        /// </summary>
        public int height { get => (int)Math.Ceiling(height1 * InchesPerDecimeter); set => height1 = value; }
    ...
    /// <summary>
    /// Name of the ability and and link to more in-depth information about the ability
    /// </summary>
